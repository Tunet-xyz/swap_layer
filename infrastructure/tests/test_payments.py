...
from infrastructure.payments.adapter import PaymentProviderAdapter, PaymentError
from infrastructure.payments.providers.stripe import StripePaymentProvider
...
class TestStripeProvider(unittest.TestCase):
    ...
    @patch('infrastructure.payments.providers.stripe.stripe.Customer.create')
    ...
    def test_create_customer_error_handling(self, mock_create):
        ...
        from infrastructure.payments.adapter import PaymentDeclinedError
