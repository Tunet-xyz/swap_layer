...
class SMSPhoneNumberMixin(models.Model):
    ...
    phone_number = models.CharField(
        max_length=20,
        db_index=True,
        help_text="Phone number in E.164 format (+1234567890)"
    )
    ...
    verification_code = models.CharField(
        ...
        blank=True,
        null=True,
        help_text="Temporary verification code"
    )
    ...
    verified_at = models.DateTimeField(
        blank=True,
        null=True,
        help_text="When the phone number was verified"
    )
    carrier_name = models.CharField(
        max_length=100,
        blank=True,
        null=True,
        help_text="Phone carrier name (from lookup)"
    )
