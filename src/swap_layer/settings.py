...
class SNSConfig(BaseModel):
    ...
    aws_access_key_id: str | None = Field(None, description="AWS Access Key ID (optional if using IAM)")
...
class IdentityPlatformConfig(BaseModel):
    ...
    workos_apps: dict[str, WorkOSAppConfig] | None = Field(None, description="WorkOS app configurations")
    auth0_apps: dict[str, Auth0AppConfig] | None = Field(None, description="Auth0 app configurations")
...
class IdentityVerificationConfig(BaseModel):
    ...
    stripe_secret_key: str | None = Field(None, description="Stripe secret key for identity verification")
...
class SwapLayerSettings(BaseModel):
    ...
    communications: CommunicationsConfig | None = Field(None, description="Communications module configuration (email and SMS)")
    storage: StorageConfig | None = Field(None, description="Storage module configuration")
    identity: IdentityPlatformConfig | None = Field(None, description="Identity/OAuth configuration")
    verification: IdentityVerificationConfig | None = Field(None, description="Identity verification configuration")
