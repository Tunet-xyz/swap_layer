...
### Added
- Added provider-neutral webhook endpoint lifecycle operations and Stripe discovery,
  create, update, and explicit delete support with a one-time signing-secret boundary.
